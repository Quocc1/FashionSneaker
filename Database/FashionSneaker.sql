...
INSERT INTO product VALUES(2, 6, 'Converse Run Star Hike', N'Giày Converse Run Star Hike là dòng sản phẩm được kết hợp giữa Converse cùng JW Anderson. Trước đó, sự kết hợp này đã trình làng những sản phẩm giày mang nhiều cải tiến để thích hợp hơn với bộ môn leo núi. 
...
INSERT INTO product VALUES(2, 1, 'Nike Air Jordan 1 High Panda Twist ', N'<p>L&agrave; một trong những đ&ocirc;i gi&agrave;y được mong đợi nhất trong m&ugrave;a giải của Nike, Air Jordan 1 &ldquo;Panda Twist&rdquo; đ&atilde; thu h&uacute;t được kh&aacute; nhiều tiếng vang kể từ khi được drop.&nbsp;<br />
