                        ...
                        <div class="col-xs-12">
                            ...
                            <form id="formSubmit" action="profile" method="post">
                                <div class="form-group">
                                    <label class="text-dark control-label no-padding-right">Nhập Mật Khẩu Cũ</label>
                                    <div class="">
                                        <input type="password" required class="form-control" id="oldPassword" name="oldPassword" value=""/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="text-dark control-label no-padding-right">Nhập Mật Khẩu Mới</label>
                                    <div class="">
                                        <input type="password" required class="form-control" id="newPassword" name="newPassword" value=""/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="">
