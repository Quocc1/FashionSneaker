...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="views/admin/#" data-toggle="collapse" data-target="#collapseTwo"
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="views/admin/buttons.html">Buttons</a>
                        <a class="collapse-item" href="views/admin/cards.html">Cards</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="views/admin/#" data-toggle="collapse" data-target="#collapseUtilities"
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="views/admin/utilities-color.html">Colors</a>
                        <a class="collapse-item" href="views/admin/utilities-border.html">Borders</a>
                        <a class="collapse-item" href="views/admin/utilities-animation.html">Animations</a>
                        <a class="collapse-item" href="views/admin/utilities-other.html">Other</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="views/admin/#" data-toggle="collapse" data-target="#collapsePages"
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="views/admin/login.html">Login</a>
                        <a class="collapse-item" href="views/admin/register.html">Register</a>
                        <a class="collapse-item" href="views/admin/forgot-password.html">Forgot Password</a>
                        <div class="collapse-divider"></div>
                        <h6 class="collapse-header">Other Pages:</h6>
                        <a class="collapse-item" href="views/admin/404.html">404 Page</a>
                        <a class="collapse-item" href="views/admin/blank.html">Blank Page</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="views/admin/charts.html">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="views/admin/tables.html">
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="views/admin/#" data-toggle="modal" data-target="#logoutModal">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="views/admin/#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <div class="dropdown no-arrow">
                                        <a class="dropdown-toggle" href="views/admin/#" role="button" id="dropdownMenuLink"
                                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                            ...
                                            <a class="dropdown-item" href="views/admin/#">Action</a>
                                            <a class="dropdown-item" href="views/admin/#">Another action</a>
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item" href="views/admin/#">Something else here</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- Card Body -->
    ...
    <a class="scroll-to-top rounded" href="views/admin/#page-top">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="views/admin/login.html">Logout</a>
                </div>
            </div>
        </div>
    </div>
